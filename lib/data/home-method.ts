...
export const homeMethod: MethodStep[] = [
  {
    ...
    body: 'We audit your entire data layer — product events, warehouse tables, pipelines, definitions. We fix what\'s broken, fill what\'s missing, rebuild what drifts. Every team pulls the same number for the same question.',
  },
  {
    number: '02',
    eyebrow: 'Unification',
  ...
  },
  {
    ...
    body: 'We build the reporting layer your team will actually use — executive dashboards, product funnels, cohort analyses. The handful that change how you operate.',
  },
  {
    number: '04',
    eyebrow: 'Compounding',
